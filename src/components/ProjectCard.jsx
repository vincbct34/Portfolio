...
export const ProjectCard = ({ title, image, description, skills, link }) => {
  ...
  return (
    <div className="w-full max-w-xs md:max-w-md p-6 bg-gradient-light dark:bg-gradient-dark dark:bg-dark-second rounded transition-all duration-300 ease-in-out hover:shadow-darkProfileShadow hover:dark:shadow-lightProfileShadow transform hover:scale-105">
      {/* Project image */}
